...
export default function TrendingGallery() {
  ...
  return (
    <div className="w-full px-4 sm:px-0  m-auto pt-8 flex flex-col gap-8 bg-white text-black">
      {/* En-tête avec titre et toggle */}
      <div className="w-full sm:max-w-[1160px] m-auto px-4 sm:px-8 flex flex-col sm:flex-row gap-4 sm:gap-5 items-start sm:items-center">
